    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EStatus.putString("name", et_name.getEditableText().toString());
                EStatus.apply();
                EStatus.putString("dob", et_dob.getEditableText().toString());
                EStatus.apply();
                EStatus.putString("gender", ((RadioButton) findViewById(rg_gender.getCheckedRadioButtonId())).getText().toString());
                EStatus.apply();
                EStatus.putString("marital", sp_marital.getSelectedItem().toString());
                EStatus.apply();
                EStatus.putString("reg_time", et_reg_time.getEditableText().toString());
                EStatus.apply();
                String str = "";
                if (ck_smoke.isChecked()) str += "Smoking ";
                if (ck_alcohol.isChecked()) str += "Alcohol ";
                EStatus.putString("addict", str);
                EStatus.apply();
                startActivity(new Intent(getApplicationContext(), ex2_disp.class));
            }
        });
